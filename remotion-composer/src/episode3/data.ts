...
export const episode3Data = raw as unknown as Episode3Data;

// --- Music volume: same GSAP-style duck keyframe expansion used in Episode 2,
// each segment ramps from the previous segment's end value with sine easing. ---
