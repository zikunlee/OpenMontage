...
// cover-fill background plus a centered contain-fit foreground — the same
// technique used for the Episode 1/2 teasers, implemented here in CSS. Both
// layers render the SAME source at full container size (1080x1920) with
// different object-fit values, rather than sizing off a naturally-short
// element — sizing off the element left large black bars top/bottom.
...
// Bold, oversized karaoke captions — larger than the full-episode captions,
// tuned for silent autoplay scrolling.
...
const MusicLayer: React.FC<{ music: MusicConfig }> = ({ music }) => {
  ...
  // Ducks fully while inside a narration segment, eased in/out at the edges.
